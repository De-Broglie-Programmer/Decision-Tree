...
class Tree:
    ...
    def __init__(self,
        ...
        self.generate(self.root,h,types)
        
        
    def generate(self, pivot: Node, h:int, types):
        ...
        (self.split_feature_index, self.split_value, left_class_features,   
         left_class_labels,right_class_features,right_class_lables)  = pivot.points.split_with_best_gain() 
        ...
        self.generate(left_node,h-1,types)
        self.generate(right_node,h-1,types)
